...
#ifdef USE_MEBII
   PLIB_PORTS_PinModePerPortSelect (PORTS_ID_0, PORT_CHANNEL_A, SWITCH_S1, BSP_DIGITAL_PIN);
   PLIB_PORTS_ChangeNoticePullUpPerPortEnable (PORTS_ID_0, PORT_CHANNEL_A, SWITCH_S1);
   PLIB_PORTS_PinDirectionInputSet ( PORTS_ID_0, PORT_CHANNEL_A, SWITCH_S1 );

   PLIB_PORTS_PinDirectionOutputSet( PORTS_ID_0, PORT_CHANNEL_H, LED_4 );
   PLIB_PORTS_PinDirectionOutputSet( PORTS_ID_0, PORT_CHANNEL_H, LED_5 );

   PLIB_PORTS_PinClear( PORTS_ID_0, PORT_CHANNEL_H, LED_4 );
   PLIB_PORTS_PinClear( PORTS_ID_0, PORT_CHANNEL_H, LED_5 );
...
{
   /* switch ON the LED */
   PLIB_PORTS_PinWrite ( PORTS_ID_0, PORT_CHANNEL_H, led, 1 );
}

void BSP_SwitchOFFLED(BSP_LED led)
{
   /* switch OFF the LED */
   PLIB_PORTS_PinWrite ( PORTS_ID_0, PORT_CHANNEL_H, led, 0 );
}
