...
#ifndef _DRV_USART_CONFIG_H
#define _DRV_USART_CONFIG_H
...
/* USART driver objects configuration
  ...
  Description
    Sets up the maximum number of hardware instances that can be supported.  It
    is recommended that this number be set exactly equal to the number of USART
    modules that are needed by the application. Hardware Instance support
    consumes RAM memory space.  If this macro is not defined, then the driver
...
/* USART Interrupt Mode Operation Control
  ...
  Description:
    ...
    interrupt should be defined in the application. The DRV_USART_Tasks()
...
/* USART Driver Byte Model Support
  ...
  Description:
    ...
    not support buffer queue and read write models.
...
/* USART Driver Read Write Model Support
  ...
  Description:
    ...
    read write model operation.  If read write model operation is enabled, then
    DRV_USART_BYTE_MODEL_SUPPORT should not be true.
...
// *****************************************************************************
// *****************************************************************************
// Section: Static Overrides. These macros are applicable only if the driver is
...
/* Transmit Interrupt Source
  ...
  Description:
    ...
    member of the DRV_USART_INIT initialization data structure in the driver
...
/* Transmit DMA Channel Interrupt Source
  ...
  Description:
    ...
    dmaInterruptTransmit member of the DRV_USART_INIT initialization
...
/* Receive DMA Channel Interrupt Source
  ...
  Description:
    Macro to define the Receive DMA Channel interrupt source in case of static
    driver. The interrupt source defined by this macro will override the
    dmaInterruptReceive member of the DRV_USART_INIT initialization
    data structure in the driver initialization routine. This value should be
    set to the DMA channel interrupt enumeration in the Interrupt PLIB for the
    microcontroller.
...
/* USART Driver Receive DMA Channel 
  ...
  Description:
    ...
    of the DRV_USART_INIT initialization data structure in the driver
